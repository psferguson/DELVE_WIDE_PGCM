...
def main():
    ...
    parser.add_argument('--inputFile', help='name of the input file', default='DELVE_Calib_expimgfileinfo_ncsa_DEEP.csv')
    ...
    status = DELVE_Calib_concat_se_objects_nsca(args)

    return status

#--------------------------------------------------------------------------

def DELVE_Calib_concat_se_objects_nsca(args):
    ...
    df_input['FILENAME'] = df_input['CLINK'].apply(lambda x: os.path.basename(x))
