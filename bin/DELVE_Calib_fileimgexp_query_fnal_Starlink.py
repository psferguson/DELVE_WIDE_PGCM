...
query = \
         """select f.expnum, f.ccdnum, e.band, 
            ...
            where f.expnum = e.expnum and
                  (e.expnum = 908899 or e.expnum = 823911 or e.expnum = 908902 or e.expnum = 909127 or e.expnum = 909130 or e.expnum = 862906 or e.nite = 20191117) and 
                  f.filetype = 'fullcat'
...
query = \
    """select e.expnum,
       ...
       from exposure e
       where 
            (e.expnum = 908899 or e.expnum = 823911 or e.expnum = 908902 or e.expnum = 909127 or e.expnum = 909130 or e.expnum = 862906 or e.nite = 20191117) \
    """
